...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "buck2hub.com" }
  ...
  config.hosts << "admin.buck2hub.com"
  config.hosts << "auth.buck2hub.com"
  config.hosts << "api.buck2hub.com"
  config.hosts << "buck2hub.com"

...
Rails.application.configure do
  ...
  config.hosts << "admin.rk8s.xuanwu.openatom.cn"
  config.hosts << "auth.rk8s.xuanwu.openatom.cn"
  config.hosts << "api.rk8s.xuanwu.openatom.cn"
  config.hosts << "rk8s.xuanwu.openatom.cn"
  config.hosts << "campsite-api.mega-rk8s.svc.cluster.local:8080"
